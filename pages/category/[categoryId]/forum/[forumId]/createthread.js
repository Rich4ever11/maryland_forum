                  ...
                  <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                    <div className="grid grid-cols-3 gap-6">
                      <div className="col-span-3 sm:col-span-2">
                        <div className="mb-4">
                          <label className="font-thin leading-tight md:text-5xl text-3xl pb-4">
                            Create Your Thread Here
                          </label>
                        </div>
                        <div className="mt-2 flex rounded-md shadow-sm">
                          <span className="font-thin leading-tight inline-flex items-center rounded-l-md border border-r-0 border-gray-300 px-3 text-stone-900 sm:text-xl">
                            Thread Title
                          </span>
                          <input
                            type="text"
                    ...
                    <div>
                      <span className="font-thin leading-tight border-gray-300 px-3 text-stone-900  text-3xl">
                        Thread Post
                      </span>
                      <div className="mt-2">
                        <textarea
                          ...
                          name="postText"
                          rows="3"
                          className="mt-1 block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:p-1.5 sm:text-sm sm:leading-6"
                          onChange={(e) => {
